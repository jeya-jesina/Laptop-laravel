...
export default function BudgetList() {
  ...
  const fetchBudgets = async (companyId) => {
    ...
    try {
      ...
      const res = await api.get(
        `/budget/get_all?company_id=${companyId}`
      );
  ...
  const toggleStatus = async (budget) => {
    ...
    <>
      ...
      <div className="sl-page">
        ...
        <div className="sl-header">
          ...
          <div>
            <h1>💰 Budgets</h1>
            <p>Manage price range budgets</p>
          </div>
              ...
              {!selectedCompany ? (
                ...
                <tr>
                  <td colSpan="5" className="sl-empty">
                    Select a company to view budgets
                  </td>
                </tr>
          ...
          {filtered.length > ITEMS_PER_PAGE && (
            ...
            >
              <div style={{ fontSize: 13, color: "#64748b" }}>
                ...
                of <strong>{filtered.length}</strong> budgets
              </div>
