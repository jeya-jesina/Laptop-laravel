...
export default function ProfessionList() {
  ...
  useEffect(() => {
    ...
    if (selectedCompany) {
      ...
      fetchProfessions(selectedCompany);
  ...
  const fetchProfessions = async (companyId) => {
    ...
    try {
      ...
      const res = await api.get(
        `/profession/get_all?company_id=${companyId}`
      );
  ...
  const handleDelete = async (profession) => {
    ...
    if (!window.confirm(`Delete profession "${profession.name}"?`)) return;
    ...
    try {
      ...
      if (res.data.status) {
        ...
        setProfessions((prev) =>
          prev.filter((s) => s.id !== profession.id)
        );
  ...
  const filtered = professions.filter((s) =>
    ...
    <>
      ...
      <div className="sl-page">
        ...
        <div className="sl-header">
          ...
          <div>
            <h1>💼 Professions</h1>
            <p>Manage laptop usage categories</p>
          </div>
              ...
              {!selectedCompany ? (
                ...
                <tr>
                  <td colSpan="4" className="sl-empty">
                    Select a company to view professions
                  </td>
                </tr>
          ...
          {filtered.length > ITEMS_PER_PAGE && (
            ...
            >
              <div style={{ fontSize: 13, color: "#64748b" }}>
                ...
                of <strong>{filtered.length}</strong> professions
              </div>
