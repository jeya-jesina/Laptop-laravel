...
>
  ...
  <label className="pf-label">
    Sub Category <span style={{fontSize:"9.5px", textTransform:"none", color:"#94a3b8"}}>(Optional)</span>
  </label>
...
<span className="pf-select-arrow">▾</span>
            ...
            <div className="pf-field" style={{ marginTop: "0.5rem" }}>
              <label className="pf-label">Offer</label>
              <label
  ...
  <div className="pf-select-wrap pf-input-wrap">
    ...
    <span className="pf-select-arrow">▾</span>
            ...
            <p className="pf-section" style={{marginTop:"1.25rem"}}>Laptop Details</p>
            <div className="pf-grid-2">
              <div className="pf-field">
                <label className="pf-label">Model</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">💻</span>
                  <input className="pf-input" placeholder="Model"
                    value={form.model}
              ...
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">⚙️</span>
                  <input className="pf-input" placeholder="Processor"
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🧠</span>
                  <input className="pf-input" placeholder="e.g. 8GB"
                    value={form.ram}
                    onChange={e => set("ram", e.target.value)} />
                </div>
              </div>
              <div className="pf-field">
                <label className="pf-label">Storage</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">💾</span>
                  <input className="pf-input" placeholder="e.g. 512GB"
                    value={form.storage}
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                <label className="pf-label">Storage Type</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🗄️</span>
                  <input className="pf-input" placeholder="e.g. SSD / HDD"
                    value={form.storage_type}
                    onChange={e => set("storage_type", e.target.value)} />
                </div>
              </div>
              <div className="pf-field">
                <label className="pf-label">Graphics</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🎮</span>
                  <input className="pf-input" placeholder="Graphics"
                    value={form.graphics}
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🖥️</span>
                  <input className="pf-input" placeholder="e.g. 15.6 inch"
              ...
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🪟</span>
                  <input className="pf-input" placeholder="Operating system"
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                <label className="pf-label">Condition Grade</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">⭐</span>
                  <input className="pf-input" placeholder="e.g. A / B / C"
                    value={form.condition_grade}
                    onChange={e => set("condition_grade", e.target.value)} />
                </div>
              </div>
              <div className="pf-field">
                <label className="pf-label">Battery Health</label>
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🔋</span>
                  <input className="pf-input" placeholder="e.g. 85%"
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🛡️</span>
                  <input className="pf-input" placeholder="Warranty"
                    value={form.warranty}
                    onChange={e => set("warranty", e.target.value)} />
                </div>
              </div>
              <div className="pf-field">
                <label className="pf-label">Charger Available</label>
                <div className="pf-select-wrap pf-input-wrap">
                  <span className="pf-input-icon">🔌</span>
                  <select
                    className="pf-select"
            ...
            <p className="pf-section">Product Media (Cloudinary)</p>
